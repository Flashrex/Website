...
function addGames() {
    ...
    for(var i = 0; i < Projects.length; i++) {
        ...
        if(Projects[i].file !== "") {
            projectbox.innerHTML += '<div class="project" id="project_' +i +'">'
            +'<img src=' +Projects[i].logopath +' alt=img_' +i +'" width="100" height="100"> '
            +'<h4>' +Projects[i].headline +'</h4>'
            +'<span><a href="' +Projects[i].file +'">Play!</a></span> <span><a href="' +Projects[i].link +'">' +linkText +'</a></span>'
            ...
            +'<img src=' +Projects[i].logopath +' alt=img_' +i +'" width="100" height="100"> '
            +'<h4>' +Projects[i].headline +'</h4>'
            +'<span><a href="' +Projects[i].link +'">' +linkText +'</a></span>'
            +'<p>' +Projects[i].description + '</p>'
            +'</div>';
        }

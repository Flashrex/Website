...
function addBlogPost() {
    ...
    for(var i = 0; i < blogposts.length; i++) {
        gridbox.innerHTML += '<div class="blogpost" id="blogpost_' +i +'"' +'>'
